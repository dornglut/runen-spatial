...
| `runen-spatial-demand` | `runen_spatial_demand` | `crates/runen_spatial_demand` | deterministic multi-source desired spatial coverage, priority, retention, pinning, membership diffs | actual availability, backend work, IO, product purpose | retain with accepted neutral demand API |
