use crate::{DemandClass, DemandRank, DemandSourceId};
...
impl DemandedChunk {
    pub(crate) const fn new(
        ...
        Self {
            ...
            class,
            best_source_id,
            pinned: matches!(class, DemandClass::Pinned),
        }
    }
    ...
    pub const fn best_source_id(&self) -> DemandSourceId {
        self.best_source_id
    }
