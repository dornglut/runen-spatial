...
- a bounded content-agnostic streaming controller with orthogonal availability/operation/failure state, exact request correlation, deterministic reversal, working-set admission, and independent load/unload concurrency limits;
